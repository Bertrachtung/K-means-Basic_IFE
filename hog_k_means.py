...
# -*- coding: utf-8 -*-
"""
Created on Fri May 17 21:53:08 2019
There are two way to use the hog api in python, one is in opencv and the other is in skiimage. Here I choose the latter.
@author: tsao
"""
...
def load_dataset(feature_method):
    path = '/Users/tsao/desktop/datasetToge/war&flouwer/'
    imlist = [os.path.join(path, f) for f in os.listdir(path) if f.endswith('.jpg')]
    features = np.zeros([len(imlist), 820800])
